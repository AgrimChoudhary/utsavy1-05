...
CREATE POLICY "Event hosts can view all likes" ON wish_likes
  FOR SELECT
  TO public
  USING (
    EXISTS (
...
-- Guests can like wishes for events they're invited to
CREATE POLICY "Let me create a comprehensive implementation plan for integrating the Wishing Wall feature into your wedding invitation platform.
