...
import { Badge } from '@/components/ui/badge';
  import { MapPin, Users, Settings, Eye, Share2, MoreHorizontal, CalendarIcon } from 'lucide-react';
...
export const HostedEvents = ({ events }: HostedEventsProps) => {
    ...
    return (
      <Card className="text-center py-12 border-dashed border-2">
        <CardContent className="flex flex-col items-center p-6">
          ...
          <h3 className="text-xl font-semibold mb-2">No hosted events yet</h3>
          <p className="text-gray-500 max-w-xs mx-auto">
            Click the Create Event button above to get started with invitations.
          </p>
        </CardContent>
      </Card>
    );
